...
coordinateSystemUserNumber = main_WL_dynamicCai.user_number
regionUserNumber = main_WL_dynamicCai.user_number
basisUserNumber = main_WL_dynamicCai.user_number
pressureBasisUserNumber = main_WL_dynamicCai.user_number + 1
generatedMeshUserNumber = main_WL_dynamicCai.user_number
meshUserNumber = main_WL_dynamicCai.user_number
cellMLUserNumber = main_WL_dynamicCai.user_number
decompositionUserNumber = main_WL_dynamicCai.user_number
equationsSetUserNumber = main_WL_dynamicCai.user_number
problemUserNumber = main_WL_dynamicCai.user_number
#Mesh component numbers
linearMeshComponentNumber = 1
#Fields
geometricFieldUserNumber = main_WL_dynamicCai.user_number
fibreFieldUserNumber = main_WL_dynamicCai.user_number + 1
dependentFieldUserNumber = main_WL_dynamicCai.user_number + 2
materialsFieldUserNumber = main_WL_dynamicCai.user_number + 3
equationsSetFieldUserNumber = main_WL_dynamicCai.user_number + 4
cellMLModelsFieldUserNumber = main_WL_dynamicCai.user_number + 5
cellMLStateFieldUserNumber = main_WL_dynamicCai.user_number + 6
cellMLParametersFieldUserNumber = main_WL_dynamicCai.user_number + 7
cellMLIntermediateFieldUserNumber = main_WL_dynamicCai.user_number + 8
...
fileName = 'WL_D_afterload' + str(value_afterload) + '.csv'
...
##with open('Output_Data/' + fileName, "a") as csvfile:
##    resultswriter = csv.writer(csvfile, dialect='excel')
